package com.shellaia.dashboard;

import com.shellaia.dashboard.util.ResourceReader;
...
@AIAController(name = "com.shellaia.dashboard.planner",
    type = ServerType.AIA,
    visible = true,
  ...
  public Boolean process(CommandContext context) {
    ...
    try {
      ...
      if (action != null) {
        ...
        context.execute("com.shellaia.agent.dashboard", command, internalContext);
      };
