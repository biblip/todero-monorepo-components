...
public final class TaskManagerAgentCapabilities implements AgentCapabilityProvider {
  ...
  public AgentCapabilityManifest manifest() {
    return AgentCapabilityManifest.builder()
        .contractVersion(2)
        .agentName("com.shellaia.agent.taskmanager")
        .intents(List.of(
        ...
        .routingHints(Map.of(
            "toolComponentName", "com.shellaia.taskmanager",
            "routingKeywords", "tasks,todo,planning,assignment,schedule,workflow,claims,metrics",
            "domain", "task",
            "confidenceBias", "high"
        ))
        .build();
