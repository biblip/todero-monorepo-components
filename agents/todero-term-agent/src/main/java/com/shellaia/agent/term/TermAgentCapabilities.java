  ...
  public AgentCapabilityManifest manifest() {
    return AgentCapabilityManifest.builder()
        ...
        .commands(List.of(
            ...
            command("write", List.of("<idOrName>", "<viewerId>", "<dataB64>")),
            command("ctrlc", List.of("<idOrName>")),
            command("events", List.of("ON|OFF", "<idOrName>", "<viewerId>")),
            ...
            command("attach", List.of("<idOrName>", "<viewerId>")),
            command("heartbeat", List.of("<idOrName>", "<viewerId>")),
            command("detach", List.of("<idOrName>", "<viewerId>")),
            command("resize", List.of("<idOrName>", "<viewerId>", "<cols>", "<rows>")),
